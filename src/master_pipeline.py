...
def main():
    ...
    parser.add_argument("--dataset_config", type=str, default="cic_iomt_2024",
                        help="Hydra数据集配置文件名，例如 cic_ids_2017,cic_iomt_2024")

    # 🎯 核心修复 1：将默认路径直接设定为你服务器上的真实绝对路径
    parser.add_argument("--base_data_dir", type=str,
                        default="/tmp/pycharm_project_908/processed_data/CIC-IoMT-2024-session-srcIP_srcPort_dstIP_dstPort_proto",
                        help="会话数据的根目录,CIC-IoMT-2024,CIC-IDS-2017")
