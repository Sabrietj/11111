...
import os
import pandas as pd
from print_manager_for_process_log import __PrintManager__
...
class ProcessLogs(EvaluateData):
    ...
    def evaluate_features(self, path_to_dataset):
        ...
        self.create_session_tuple_for_ssl_log(path_to_dataset)
    ...
    def create_session_tuple_for_ssl_log(self, path_to_dataset):
